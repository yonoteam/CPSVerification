...
interpretation rel_antidomain_kleene_algebra: antidomain_kleene_algebra rel_ad "op \<union>" "op O" Id "{}" "op \<subseteq>" "op \<subset>" rtrancl
...
interpretation trace_antidomain_kleene_algebra: antidomain_kleene_algebra trace_a "op \<union>" t_prod t_one t_zero "op \<subseteq>" "op \<subset>" t_star
proof
...
interpretation rel_antirange_kleene_algebra: antirange_semiring "op \<union>" "op O" Id "{}" rel_ar "op \<subseteq>" "op \<subset>"
apply unfold_locales
apply (simp_all add: rel_ar_def)
by auto

interpretation rel_modal_kleene_algebra: modal_kleene_algebra "op \<union>" "op O" Id "{}" "op \<subseteq>" "op \<subset>" rtrancl rel_ad rel_ar
apply standard
